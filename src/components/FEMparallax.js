...
function FemParallax() {
    return (
        <div>
            ...
            <div className="card">
                    <img src={PastelTown} alt="girl by vending machine" className="card-overlay image"/>
                ...
                <div className="card">
                    <img src={PurpleTown} alt="girl in space" className="card-overlay image"/>
                    <div className="btn-text">
                ...
                <div className="card">
                    <img src={GreenTown} alt="girl next to arcade" className="card-overlay image"/>
                    <div className="btn-text">
